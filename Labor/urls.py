...
# 获取劳工班组信息
labor.add_url_rule('/class/group', methods=['get'], view_func=GetAllLaborLeader.as_view('group_info_labor'))
# 获取项目下劳工
labor.add_url_rule('/one/project', methods=['get'], view_func=GetOnePAllL.as_view('get_on_project'))
