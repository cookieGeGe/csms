...
CREATE TABLE `tb_company`  (
  ...
  `License` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '营业执照（资质图片）',
  ...
  `CityID` int(11) NULL DEFAULT NULL COMMENT '所属市ID',
  `DistrictID` int(11) NULL DEFAULT NULL COMMENT '区县ID',
  PRIMARY KEY (`ID`) USING BTREE
...
-- ----------------------------
-- Table structure for tb_pic_group
-- ----------------------------
DROP TABLE IF EXISTS `tb_pic_group`;
CREATE TABLE `tb_pic_group`  (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `Name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '公司分组名字',
  `Type` int(11) NULL DEFAULT NULL COMMENT '分组类型，执照或者公司照片',
  `GUrl` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '分组的url',
  `CID` int(11) NULL DEFAULT NULL COMMENT '公司ID',
  PRIMARY KEY (`ID`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Table structure for tb_pics
-- ----------------------------
DROP TABLE IF EXISTS `tb_pics`;
CREATE TABLE `tb_pics`  (
  `ID` int(11) NOT NULL,
  `GroupID` int(11) NULL DEFAULT NULL COMMENT '分组ID',
  `Purl` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '图片URL',
